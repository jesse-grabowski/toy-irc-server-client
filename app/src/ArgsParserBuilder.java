...
public interface ArgsParserBuilder<T extends ArgsProperties> {
    ...
    ArgsParserBuilder<T> addBooleanFlag(char shortKey, String longKey, BiConsumer<T, Boolean> propertiesSetter, String description, boolean required);
    ArgsParserBuilder<T> addStringFlag(char shortKey, String longKey, BiConsumer<T, String> propertiesSetter, String description, boolean required);

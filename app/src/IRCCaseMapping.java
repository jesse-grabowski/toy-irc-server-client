...
public enum IRCCaseMapping {
    ...
    RFC1459_STRICT("rfc1459-strict", IRCCaseMapping::casefoldRfc1459StrictNickname, IRCCaseMapping::casefoldRfc1459StrictChannel);
    ...
    private static final char[] RFC1459_CASEFOLD = initializeCasefold(128, Map.ofEntries(
            Map.entry('[', '{'),
            Map.entry(']', '}'),
            Map.entry('\\', '|'),
            Map.entry('~', '^')
    ));
    private static final char[] RFC1459_STRICT_CASEFOLD = initializeCasefold(128, Map.ofEntries(
            Map.entry('[', '{'),
            Map.entry(']', '}'),
            Map.entry('\\', '|')
    ));
    ...
    private static StringBuilder casefold(char[] dictionary, StringBuilder sb, char[] s, int startInclusive, int endExclusive) {
